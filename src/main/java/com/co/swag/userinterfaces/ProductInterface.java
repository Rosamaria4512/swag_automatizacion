...
public class ProductInterface {
    ...
    public static Target BTN_DELET_CART_PRODUCT=Target.the("borrar producto del carrito").locatedBy("(//button[@class='btn btn_secondary btn_small cart_button'])[1]");
    public static Target CONTENEDOR_PRODUCTOS=Target.the("borrar producto del carrito").locatedBy("(//div[@class='cart_item'])[1]");
